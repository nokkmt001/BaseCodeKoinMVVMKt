...
inline fun <reified T : Parcelable> Fragment.parcelArgument() = lazy { arguments!!.getParcelable<T>(T::class.java.name)}

inline fun <reified T : Parcelable> Fragment.parcelArguments() = arguments!!.getParcelable<T>(T::class.java.name)

fun Fragment.getArrayListStringArgs() = arguments?.getStringArrayList("StringArrayList")
